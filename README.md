...
<p align="left">
  <img src="https://komarev.com/ghpvc/?username=trisindopanji&label=Profile%20views&color=0e75b6&style=flat" alt="profile views" />
</p>

I’m an **IT Support, Web Developer & System Builder** based in Indonesia.  
Saat ini aktif mengembangkan berbagai aplikasi internal perusahaan seperti:

- Sistem **UMS**, **HRIS**
- Sistem **pendataan aset IT** berbasis web + QR Code
- Aplikasi **input & manajemen film** (AdminLTE + PHP)
- **Typeform-like multi-step form** yang tersimpan ke Google Sheets
- Integrasi API: **OMDb**, **Select2 Autocomplete**
- Remote database, struktur sistem, dan deployment berbasis Windows Server
